...
img_folder = os.path.join('../datasets/adobe240fps/frame_LRx4/train')
txt_file = '../datasets/adobe240fps/train_lmdb_list.txt'
lmdb_save_path = '../datasets/adobe240fps/adobe240fps_train_LR7.lmdb'

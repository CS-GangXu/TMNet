...
def vimeo7():
    ...
    if mode == 'GT':
        img_folder = '/home/ubuntu/Dataset/Vimeo-90k/vimeo_septuplet/sequences/' + phase
        lmdb_save_path = '/home/ubuntu/Dataset/Vimeo-90k/vimeo_septuplet/vimeo7_' + phase + '_GT.lmdb'
        txt_file = '/home/ubuntu/Dataset/Vimeo-90k/vimeo_septuplet/sep_' + phase + 'list.txt'
        H_dst, W_dst = 256, 448
    elif mode == 'LR':
        img_folder = '/home/ubuntu/Dataset/Vimeo-90k/vimeo_septuplet/sequences_LR/' + phase
        lmdb_save_path = '/home/ubuntu/Dataset/Vimeo-90k/vimeo_septuplet/vimeo7_' + phase + '_LR7.lmdb'
        txt_file = '/home/ubuntu/Dataset/Vimeo-90k/vimeo_septuplet/sep_' + phase + 'list.txt'
        H_dst, W_dst = 64, 112
    n_thread = 40
    ########################################################
